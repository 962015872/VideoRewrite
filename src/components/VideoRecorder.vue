    ...
    <div class="lum-dialog-mask animated fadeIn">
      <el-container class="lum-dialog-box">
        ...
        <el-footer class="footer" height="60px">
          ...
          <el-button
            v-show="(recorderStatus == 2 || recorderStatus == 1) && duration>1"
            type="danger"
            size="small"
            round
            @click="stopRecorder"
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        console.log(file)
        this.$emit('send',this.duration, file)
        
      },
      connect() {
        this.socket = new WebSocket(`ws://192.168.1.4:8090/paddlespeech/asr/streaming`);
